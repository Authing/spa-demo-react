 ...
 */
export function enhancedLogin (codeChallengeDigestMethod = 'S256', codeChallengeMethod = 'S256') {
 ...
 */
export function enhancedLogout (customRedirectUri = '') {
...
export async function enchancedLoginCallback () {
